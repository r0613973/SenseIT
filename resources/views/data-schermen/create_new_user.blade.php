...
@section('title', 'Nieuwe user aanmaken')
@section('main')
    <div class="container " id="new_user">

        <div class="row text-center justify-content-center d-flex align-items-center mt-5 pt-5">
            <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8  text-left card create_user_form">
                <h2 class="card-header text-center">Nieuwe user</h2>
                <form action="/user" method="post" id="create_user_form">
                    @csrf
                    <div class="card-body">
                        <div class="row ">
                            ...
                            <div class="form-group formulier col-lg-6  col-md-6 mb-3">
                                ...
                                <input class="form-control" name="wachtwoord" id="wachtwoord" data-toggle="tooltip"
                                       data-placement="right"
                                       type="text"
                                       title="Vul hier het wachtwoord van de user in"
                                       placeholder="Wachtwoord van de user"
                                       value="">
                            </div>
                            ...
                            <div class="form-group formulier col-lg-6 col-md-6 mb-3">
                                ...
                                <select class="form-control" name="usertype" id="usertype">
                                    @foreach($userTypes as $userType)
                                            <option
                                                    value="{{$userType['UserTypeID']}}">{{$userType['UserTypeName']}}
                                            </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row justify-content-around">
                            <button type="submit" class="col col-lg-5 col-md-5 col-sm-12 btn btn-light m-2">User toevoegen</button>
                            <a href="/user" class="col col-lg-5 col-md-5 col-sm-12 btn btn-light m-2">Naar user overzicht</a>
                        </div>
                    </div>
                </form>
            </div>
